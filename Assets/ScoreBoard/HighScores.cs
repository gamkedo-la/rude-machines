...
{
    const string privateCode = "qQdhiQlz90KhZYv3aS5qGwER7wMiiNjki";  //Key to Upload New Info
    const string publicCode = "62d6fda98f40bb84ec78644b";   //Key to download
